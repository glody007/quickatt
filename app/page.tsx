...
export const metadata: Metadata = {
  ...
  description: "Authentication built using the next-auth.",
}
      ...
      <div className="container relative h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        <Link
          ...
          className={cn(
            ...
            "absolute right-4 top-4 md:right-8 md:top-8 flex gap-1"
          )}
        >
          Home
        </Link>
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
          ...
          <div className="relative z-20 flex items-center text-lg font-medium">
            <div className="h-8 w-12 rounded-lg bg-green-300 mr-2" />
            Quickatt Inc
          </div>
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                ...
                and visitor management, look no further!.&rdquo;
              </p>
